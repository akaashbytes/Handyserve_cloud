 ...
 * a resource they are not authorized for — e.g., a CUSTOMER hitting an
 * admin-only endpoint.
 *
 * Returns HTTP 403 Forbidden with a structured JSON body instead of the
 * default Spring Security HTML error page.
 *
 * Response shape:
 * {
